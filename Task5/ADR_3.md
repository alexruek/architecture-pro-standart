...
- **Минусы:** Кредитный конвейер — коробочное BPM-решение (Camunda), не предназначенное для прямых онлайн-вызовов из клиентских приложений. Создаётся жесткая связанность. Нет возможности буферизации при пиковой нагрузке. Отсутствует единое место хранения онлайн-заявок для связки с визитом в отделение.
